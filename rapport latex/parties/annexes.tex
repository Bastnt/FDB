...
%\emph{(...)} <- mis dans le code
\lstinputlisting[language=SQL, firstline=724, lastline=727]{ressources/textuelles/request_pokemon.sql}
...
%\emph{(...)}
\lstinputlisting[language=SQL, firstline=105, lastline=108]{ressources/textuelles/request_team.sql}
...
%\emph{(...)}
\lstinputlisting[language=XML, firstline=5603, lastline=5613]{ressources/textuelles/moves.xml}
...
\emph{(...)}
\lstinputlisting[language=XML, firstline=2499, lastline=2504]{ressources/textuelles/pokemons.xml}
...
\emph{(...)}
\lstinputlisting[language=XML, firstline=1911, lastline=1918]{ressources/textuelles/teams.xml}
