...
\addcontentsline{A - Extraits du modèle de données}
\hspace{0pt}
...
\section{B - Pokémon, kezako ?}
\addcontentsline{B - Pokémon, kezako ?}
\hspace{0pt}
...
\section{C - Schéma externe}
\addcontentsline{C - Schéma externe}
\hspace{0pt}
